...
export default function SplineScene() {
  return (
    <div className="w-24 h-24 relative flex items-center justify-center overflow-hidden">
      ...
      >
        {/* Inner Glows */}
        <div className="absolute top-[-20%] left-[-20%] w-[60%] h-[60%] bg-teal/30 rounded-full blur-xl" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-primary/20 rounded-full blur-xl" />
